...
# ChatGPT (OpenAI) was used to assist with debugging,
# implementation suggestions, and code refinement.
# All AI-generated suggestions were reviewed, tested,
# modified where necessary, and understood before inclusion.
